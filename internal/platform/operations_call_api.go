...
func appendDeployLogs(ctx context.Context, client *http.Client, cfg models.Config, tokens *TokenManager, deployID string, lines []string) error {
...
func appendRuleLogs(ctx context.Context, client *http.Client, cfg models.Config, tokens *TokenManager, ruleID string, lines []string) error {
...
func appendRuleDeployLogs(ctx context.Context, client *http.Client, cfg models.Config, tokens *TokenManager, ruleDeployID string, lines []string) error {
