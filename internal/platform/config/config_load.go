...
type Config struct {
	...
	BootstrapProfileVersion string
...
func Load() Config {
	apiBase := commonenv.String("RELEASEA_API_BASE_URL", "http://releasea-api.releasea-system.svc.cluster.local:8070/api/v1")
	...
	cfg := Config{
		...
		BootstrapProfileVersion: commonenv.String("RELEASEA_BOOTSTRAP_PROFILE_VERSION", ""),
