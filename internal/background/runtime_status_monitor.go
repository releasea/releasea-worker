...
func RunRuntimeMonitor(ctx context.Context, cfg models.Config, tokens *platform.TokenManager) {
...
func UpdateRuntimeStatuses(ctx context.Context, client *http.Client, cfg models.Config, tokens *platform.TokenManager) error {
...
func handlePauseWhenIdle(
	...
	if currentReplicas == 0 {
		...
		if hasTraffic {
			...
			if err := platform.ScaleDeployment(ctx, namespace, serviceName, targetReplicas); err != nil {
	...
	if err := platform.ScaleDeployment(ctx, namespace, serviceName, 0); err != nil {
...
func fetchServices(ctx context.Context, client *http.Client, cfg models.Config, tokens *platform.TokenManager) ([]models.ServicePayload, error) {
...
func updateServiceRuntime(ctx context.Context, client *http.Client, cfg models.Config, tokens *platform.TokenManager, serviceID, environment, status, reason string) error {
