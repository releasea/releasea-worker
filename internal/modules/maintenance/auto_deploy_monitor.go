...
func RunAutoDeployMonitor(ctx context.Context, cfg models.Config, tokens *platform.TokenManager) {
...
func fetchAutoDeployServices(ctx context.Context, client *http.Client, cfg models.Config, tokens *platform.TokenManager) ([]models.ServicePayload, error) {
...
func fetchDeploySnapshots(ctx context.Context, client *http.Client, cfg models.Config, tokens *platform.TokenManager) ([]deploySnapshot, error) {
